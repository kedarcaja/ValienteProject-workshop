...
Shader "Medieval Kingdom/BaseShader"
{
	Properties
	{
		...
		_Detail_1_color("Detail_1_color", Color) = (0,0.9779412,0.7756083,0)
		_Detail_1_intensity("Detail_1_intensity", Range( 0 , 1)) = 0
		_Detail_2_color("Detail_2_color", Color) = (0,0.9779412,0.7756083,0)
		_Detail_2_intensity("Detail_2_intensity", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_36_0 = ( tex2D( _Detail_mask_1_map, uv_Detail_mask_1_map ) * _Detail_1_intensity );
			float4 lerpResult46 = lerp( ( saturate( (( blendOpDest12 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest12 ) * ( 1.0 - blendOpSrc12 ) ) : ( 2.0 * blendOpDest12 * blendOpSrc12 ) ) )) , _Detail_1_color , temp_output_36_0);
			float2 uv_Detail_mask_2_map = i.uv_texcoord * _Detail_mask_2_map_ST.xy + _Detail_mask_2_map_ST.zw;
			float4 lerpResult99 = lerp( lerpResult46 , _Detail_2_color , ( tex2D( _Detail_mask_2_map, uv_Detail_mask_2_map ) * _Detail_2_intensity ));
...
/*ASEBEGIN
Version=17400
1920;0;1680;989;9239.165;1397.029;1;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;105;-8879.155,-1354.493;Inherit;False;660.3844;558.4139;Detail_mask_1_map_input;6;46;35;36;34;37;5;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;5;-8852.625,-1142.299;Inherit;True;Property;_Detail_mask_1_map;Detail_mask_1_map;22;0;Create;True;0;0;False;0;-1;7a947e26d6355c94898b3bf52c6e07da;03fc47ed4d01d9944a47fbf8d290b555;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;135;-9221.635,-1289.135;Inherit;True;Property;_Albedo_map;Albedo_map;17;0;Create;True;0;0;False;0;-1;None;d36b2f0079c27e447a4e5a68d2386808;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;4;-9590.993,-1288.864;Float;False;Property;_Base_color;Base_color;2;0;Create;True;0;0;False;0;0.427451,0.227451,0.1372549,0;0.6037736,0.6037736,0.6037736,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;37;-8850.457,-917.043;Float;False;Property;_Detail_1_intensity;Detail_1_intensity;4;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-8170.706,-926;Float;False;Property;_Detail_2_intensity;Detail_2_intensity;6;0;Create;True;0;0;False;0;0;0.7;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;62;-9317.159,-414.6369;Inherit;True;Property;_Ambient_Occlusion_map;Ambient_Occlusion_map;21;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;34;-8856.43,-1323.329;Float;False;Property;_Detail_1_color;Detail_1_color;3;0;Create;True;0;0;False;0;0,0.9779412,0.7756083,0;0.156744,0.252,0.109116,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-8524.967,-899.894;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;83;-7466.29,-1131.286;Inherit;True;Property;_Edge_mask_map;Edge_mask_map;24;0;Create;True;0;0;False;0;-1;None;ec02c37356a39874aaec5b7965cf66d3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;97;-7828.706,-1075;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;46;-8350.368,-957.2592;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;96;-8164.706,-1307;Float;False;Property;_Detail_2_color;Detail_2_color;5;0;Create;True;0;0;False;0;0,0.9779412,0.7756083,0;0.1689661,0.2547162,0.02763439,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;22;-8404,-338;Float;False;Property;_Roughnessintensity;Roughness intensity;8;0;Create;True;0;0;False;0;1;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;-9459.432,-985.8267;Inherit;True;Property;_Roughness_map;Roughness_map;18;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-6685,-1006;Float;False;Property;_AO_intensity;AO_intensity;10;0;Create;True;0;0;False;0;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-8748,-484;Float;False;Property;_Detail_roughness;Detail_roughness;9;0;Create;True;0;0;False;0;0;0.9;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;80;-6485,-1244;Inherit;False;Difference;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;-6421,-1110;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;8;-8400,-112;Inherit;True;Property;_Normal_map;Normal_map;19;0;Create;True;0;0;False;0;-1;None;f9ba1dcd5c6175e4ca4b74ec3df9160e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BlendOpsNode;35;-8457.744,-1270.125;Inherit;False;LinearBurn;True;3;0;COLOR;1,1,1,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;128;-6528,-384;Inherit;False;126;_metallic;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;98;-7732.706,-1311;Inherit;False;LinearBurn;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A6FD9268FC390EAD71612FC6F8900166BD88DB69